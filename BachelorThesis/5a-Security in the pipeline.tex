...
\colorbox{yellow}{Check up on: scans for patterns known, so might need to be partner or something with github,}\\
\colorbox{yellow}{they need to know your token patterns to detect secrets}
